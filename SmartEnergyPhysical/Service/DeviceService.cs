...
namespace SmartEnergy.Physical.Service
{
    public class DeviceService : IDeviceService
    {
        ...
        public DeviceService(PhysicalDbContext dbContext, IMapper mapper)
        {
        ...
        {
            return _mapper.Map<DeviceDto>(_dbContext.Devices.Include(x => x.Location).FirstOrDefault(x => x.ID == id));
        }

        public async Task<List<DeviceDto>> GetAllAsync()
        {
            return _mapper.Map<List<DeviceDto>>(_dbContext.Devices.Include(x => x.Location).ToList());         
        ...
        public async Task<DeviceDto> InsertAsync(DeviceDto entity)
        {
