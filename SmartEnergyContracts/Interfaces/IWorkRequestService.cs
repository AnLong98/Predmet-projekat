...
namespace SmartEnergy.Contract.Interfaces
{
    ...
    {
        public Task<List<DeviceDto>> GetWorkRequestDevicesAsync(int workRequestId);
        ...
        public Task<bool> IsCrewMemberHandlingWorkRequestAsync(int crewMemberId, int workRequestId);
    }
}
