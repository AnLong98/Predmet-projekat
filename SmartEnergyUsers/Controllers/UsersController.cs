...
{ 
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(IUserService userService, IAuthHelperService authHelperService, IAuthService authService, DaprClient daprClient)
        {
        ...
        public async Task<IActionResult> GetAllPagedAsync([FromQuery] string searchParam, [FromQuery] UserField sortBy, [FromQuery] SortingDirection direction,
        ...
        {
            UsersListDto users = await _userService.GetUsersPagedAsync(sortBy, direction, page, perPage, status, type, searchParam);
       ...
       /*
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public IActionResult GetUserAvatar(int id, string filename)
        {
