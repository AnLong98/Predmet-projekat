...
namespace SmartEnergy.Documents.Controllers
{
    ...
    public class WorkRequestController : ControllerBase
    {
        ...
        {
            return Ok(_workRequestService.GetAllAsync());
        }
        ...
        public async Task<IActionResult> GetByIdAsync(int id)
        {
            try
            {
                WorkRequestDto workRequest = await _workRequestService.GetAsync(id);
        ...
        public async Task<IActionResult> CreateWorkRequestAsync([FromBody] WorkRequestDto workRequest)
        {
            try
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> EditWorkRequestAsync(int id,[FromBody] WorkRequestDto workRequest)
        {
            try
            {
                
                if (User.IsInRole("CREW_MEMBER") &&
               await _workRequestService.IsCrewMemberHandlingWorkRequestAsync(_authHelperService.GetUserIDFromPrincipal(User), workRequest.ID))
                    return Unauthorized("Only crew members assigned to work request are allowed to edit it.");
                WorkRequestDto modified = await _workRequestService.UpdateAsync(workRequest);
                return Ok(modified);
            }
            catch (IncidentNotFoundException wnf)
            {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> DeleteWorkRequestAsync(int id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetFileAsync(int id, string filename)
        {
            try
            {
                if (User.IsInRole("CREW_MEMBER") &&
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetWorkRequestAttachmentsAsync(int id)
        {
            try
            {
                if (User.IsInRole("CREW_MEMBER") &&
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetWorkRequestStateChangesAsync(int id)
        {
            try
            {
                if (User.IsInRole("CREW_MEMBER") &&
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> DeleteAttachmentAsync(int id, string filename)
        {
            try
            {
                if (User.IsInRole("CREW_MEMBER") &&
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> ApproveWorkRequestAsync(int id)
        {
            try
            {
                if (User.IsInRole("CREW_MEMBER") &&
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> CancelWorkRequestAsync(int id)
        {
            try
            {
                if (User.IsInRole("CREW_MEMBER") &&
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> DenyWorkRequestAsync(int id)
        {
            try
            {
                if (User.IsInRole("CREW_MEMBER") &&
